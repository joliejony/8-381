...
export const getProductDetails = async (id) => {
    // implement it using similar logic as fetchProducts function       CODE ADDED
    try {
...
export const editProduct = async (id, product) => {
    // implement it using similar logic as addProduct function but use axios.put method         CODE EDIT
    try {
